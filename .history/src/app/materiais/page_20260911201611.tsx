...
export const metadata: Metadata = {
  title: "Materiais para Peritos e Profissionais | EasyMed",
  description:
    "Modelos, prompts, cursos e materiais práticos para profissionais que trabalham com perícias e questões médico-legais.",
  alternates: {
    canonical: "/materiais",
  },
};
