...
export const metadata: Metadata = {
  title: "Software para Gestão de Perícias | EasyMed",
  description:
    "Software da EasyMed para organizar processos, informações, critérios, cálculos e análises da rotina de profissionais que atuam com perícias.",
  alternates: {
    canonical: "/software",
  },
};
...
const softwareSchema = {
  ...
  "@id": "#software",
  name: "Software EasyMed Perícias",
  description:
    "Software para organizar processos, informações, critérios, cálculos e análises da rotina de profissionais que atuam com perícias.",
