...
export const metadata: Metadata = {
  title: "Perícias para Advogados | EasyMed Perícias",
  description:
    "Suporte técnico para advogados em questões médico-legais, análise de casos, estratégia probatória e acompanhamento de perícias.",
  alternates: {
    canonical: "/advogados",
  },
};
