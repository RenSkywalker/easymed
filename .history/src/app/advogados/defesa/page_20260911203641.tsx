...
export const metadata: Metadata = {
  title: "Perícias para Advogado da Defesa | EasyMed",
  description:
    "Suporte técnico para a defesa em perícias médico-legais, com análise defensiva, quesitos, acompanhamento, impugnação de laudo e segunda opinião.",
  alternates: {
    canonical: "/advogados/defesa",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  "@id": "#service",
  name: "Suporte técnico para advogado da defesa",
  description:
    "Serviços especializados para advogados da defesa em questões médico-legais e perícias.",
  provider: {
    "@id": "#organization",
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Advogado da defesa",
      item: "/advogados/defesa",
    },
  ],
};
