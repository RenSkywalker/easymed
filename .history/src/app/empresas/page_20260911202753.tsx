...
export const metadata: Metadata = {
  title: "Perícias e Suporte Técnico para Empresas | EasyMed",
  description:
    "Suporte técnico para empresas em perícias, questões médico-legais e prevenção, incluindo auditoria de SST e análise de documentação.",
  alternates: {
    canonical: "/empresas",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  "@id": "#service",
  name: "Perícias e suporte técnico para empresas",
  description:
    "Serviços especializados para empresas em perícias, questões médico-legais e prevenção.",
  provider: {
    "@id": "#organization",
  },
  serviceType: "Suporte técnico para perícias e prevenção",
  areaServed: {
    "@type": "Country",
    name: "Brasil",
  },
